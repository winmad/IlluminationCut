...
namespace embree
{
  ...
  public:
    ...
    size_t                   spp_id;  /*!< The current sample per pixel.            */
  };
  ...
  public:
    ...
    virtual  Color getPixel(Ray& ray,
                     const Ref<BackendScene>& scene, 
                     IntegratorState& state, 
                     DifferentialGeometry& dg, 
                     Vector3f& wo,Color& kd, Color& ks, float& exp,
                     bool& hit){return Color(zero);}
