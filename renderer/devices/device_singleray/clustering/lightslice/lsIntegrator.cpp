...
namespace embree
{
  lsIntegrator::lsIntegrator(const Parms& parms)
  ...
  void lsIntegrator::requestSamples(Ref<SamplerFactory>& samplerFactory, const Ref<BackendScene>& scene)
  {
  ...
  Color lsIntegrator::getPixel(Ray& ray , const Ref<BackendScene>& scene,IntegratorState& state, DifferentialGeometry& dg,Vector3f& wo,Color& kd, Color& ks,float& exp,bool& hit)
  {
    /*! Traverse ray. */
  ...
  Color lsIntegrator::Li(Ray& ray, const Ref<BackendScene>& scene, IntegratorState& state) {
