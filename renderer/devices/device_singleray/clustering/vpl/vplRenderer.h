...
#ifndef __EMBREE_VPL_RENDERER_H__
#define __EMBREE_VPL_RENDERER_H__
...
namespace embree
{
  ...
  private:
    ...
    {
    public:
      RenderJob (Ref<vplRenderer> renderer, const Ref<Camera>& camera, const Ref<BackendScene>& scene, 
