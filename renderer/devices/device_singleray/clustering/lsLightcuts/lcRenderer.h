...
#ifndef __EMBREE_LC_RENDERER_H__
#define __EMBREE_LC_RENDERER_H__
...
namespace embree
{
   ...
   *  filter. */
  class lcRenderer : public Renderer
  {
  public:

    /*! Construction from parameters. */
    lcRenderer (const Parms& parms);
  ...
  private:
    ...
    {
    public:
      RenderJob (Ref<lcRenderer> renderer, const Ref<Camera>& camera, const Ref<BackendScene>& scene, 
