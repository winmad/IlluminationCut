...
namespace embree
{
  lcIntegrator::lcIntegrator(const Parms& parms)
  ...
  void lcIntegrator::requestSamples(Ref<SamplerFactory>& samplerFactory, const Ref<BackendScene>& scene)
  {
  ...
  Color lcIntegrator::Li(Ray& ray, const Ref<BackendScene>& scene, IntegratorState& state) {
