...
#ifndef __EMBREE_CT_RENDERER_H__
#define __EMBREE_CT_RENDERER_H__
...
namespace embree
{
   ...
   *  filter. */
  class ctRenderer : public Renderer
  {
  public:

    /*! Construction from parameters. */
    ctRenderer (const Parms& parms);
  ...
  private:
    ...
    {
    public:
      RenderJob (Ref<ctRenderer> renderer, const Ref<Camera>& camera, const Ref<BackendScene>& scene, 
